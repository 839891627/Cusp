...
public enum CuspConstants {
    public static let appGroupIdentifier = "com.arvincjl.Cusp.shared"
    ...
    public static let lastRuntimeErrorKey = "shared.runtime.last-error"
    ...
    public static let localControllerPort = 1090
    public static let localControllerSecret = "cusp-local-controller"
